...
public class CadastroDeProdutoActivity extends AppCompatActivity {
    ...
    private TextInputEditText etTags, et_cadastro_de_produto_nome, et_cadastro_de_produto_labo,
            et_cadastro_de_produto_descricao, et_cadastro_de_produto_preco_consumidor, et_cadastro_de_produto_preco_compra;
    ...
    private ExtendedFloatingActionButton bt_cadastro_de_produto_salvar;
    ...
    private void getProdIntent() {
        ...
        prod = new ProdObj(extras.getInt("cat"), extras.getString("d"), true, extras.getString("id"), extras.getString("f"), extras.getString("l"), 10, extras.getString("n"), extras.getFloat("vv"), extras.getFloat("vc"), extras.getBoolean("p"), tagMap);
    ...
    private ProdObj verificarDados() {
        ...
        ProdObj prodObj = new ProdObj(CATEGORIA, descricao, true, "null", "null", labo, 7, nome, precoVenda, precoCompra, cb_cadastro_de_produto_promocional.isChecked(), tagMap);
    ...
    private void salvarDadosEmFirestore(String pathFoto, ProdObj obj) {
        ...
        ProdObj newProd = new ProdObj(obj.getCategoria(), obj.getDescr(), obj.isDisponivel(), prodId, pathFoto, obj.getLaboratorio(), obj.getNivel(), obj.getProdName(), obj.getProdValor(), obj.getPrecoDeCompra(), obj.isPromocional(), obj.getTag());
